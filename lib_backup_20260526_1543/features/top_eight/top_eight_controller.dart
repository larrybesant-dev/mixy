...
final topEightUsersProvider = FutureProvider.autoDispose
    .family<List<UserModel>, String>((ref, userId) async {
...
final topEightControllerProvider = StateNotifierProvider.autoDispose<
    TopEightController, AsyncValue<List<String>>>((ref) {
...
class TopEightController extends StateNotifier<AsyncValue<List<String>>> {
  ...
  TopEightController(this._ref, AsyncValue<List<String>> initialState)
      : super(initialState);
  ...
  Future<void> addToTopEight(String friendId) async {
    ...
    await _ref
        .read(topEightRepositoryProvider)
        .updateTopEight(userId, updatedIds);
  }
  ...
  Future<void> reorderTopEight(int oldIndex, int newIndex) async {
    ...
    await _ref
        .read(topEightRepositoryProvider)
        .updateTopEight(userId, currentIds);
  }
}
