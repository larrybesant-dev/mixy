...
class UserListPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final audience = participants.where((p) {
      final role = normalizeRoomRole(p.role, fallbackRole: '');
      final isSpeaker = isHostLikeRole(role) ||
            ...
            SliverPadding(
              ...
              sliver: SliverGrid(
                ...
                delegate: SliverChildBuilderDelegate((context, index) {
                  ...
                  return RoomUserTile(
                    displayName: displayNameById[p.userId] ??
            ...
            SliverList(
              delegate: SliverChildBuilderDelegate((context, index) {
                ...
                return _UserListTile(
                  ...
                  onTap: onTapUser == null ? null : () => onTapUser!(p),
                  onWhisper:
                      (onWhisper == null || isMe) ? null : () => onWhisper!(p),
  ...
  Widget _buildHostFeaturedSlot(RoomParticipantModel host) {
    return Container(
      ...
      child: Center(
        child: RoomUserTile(
          displayName: displayNameById[host.userId] ??
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                              isOnline ? const Color(0xFF4CAF50) : npOnVariant,
