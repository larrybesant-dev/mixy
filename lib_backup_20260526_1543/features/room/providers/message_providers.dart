...
final roomTypingUserIdsProvider =
...
final sendMessageProvider = Provider.autoDispose
  ...
  return (String message) async {
    ...
    try {
      messagingEnabled =
          ref.read(featureGateControllerProvider).enableMessaging;
    } on AssertionError {
    ...
    if (hostId.isNotEmpty) {
      final hasBlockingRelationship =
          await moderationService.hasBlockingRelationship(user.id, hostId);
...
final sendPrivateMessageProvider = Provider.autoDispose.family<
