...
class RoomSchemaException implements Exception {
  ...
  @override
  String toString() => '[RoomSchemaException] $message '
      '| roomId=$roomId '
      '| docKeys=$docKeyCount '
      '| missing=$missingKeys';
}
...
class RoomDocNormalizer {
  static RoomNormalizedDoc normalize(Map<String, dynamic> validatedDoc) {
    ...
    final meta =
        validatedDoc['meta'] as Map<String, dynamic>? ?? <String, dynamic>{};
    ...
    final isInitialLoad = (validatedDoc.isEmpty ||
        (meta['title'] == null && validatedDoc['name'] == null));
...
class RoomLiveStateMapper {
  ...
  static RoomLiveState fromFirestore({
    ...
    final normalized =
        RoomDocNormalizer.normalize(roomDoc ?? <String, dynamic>{});
