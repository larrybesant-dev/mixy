...
Future<void> main() async {
  ...
  print('Active Listeners Created: ${AppTelemetry.state.firestoreSnapshotCount}');
  
  const readCostPer1k = 0.0006; // $0.06 per 100k
  const writeCostPer1k = 0.0018; // $0.18 per 100k
  
  final sessionCost = (AppTelemetry.state.firestoreReadCount / 1000 * readCostPer1k) +
  ...
  print('Break-even User Engagement (DAU 10k): \$${(sessionCost * 10000).toStringAsFixed(2)} / day');
