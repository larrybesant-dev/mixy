...
final debugFirestorePresenceWatch =
		Provider.autoDispose.family<Stream<Map<String, dynamic>?>, String>((
			ref,
			userId,
		) {
...
final debugRtdbSessionsWatch =
		Provider.autoDispose.family<Stream<Map<dynamic, dynamic>>, String>((
			ref,
			userId,
		) {
			final uid = userId.trim();
