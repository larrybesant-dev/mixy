...
final roomsByCategoryProvider = StreamProvider.autoDispose
        ...
        SliverToBoxAdapter(
          child: Padding(
            padding: EdgeInsets.fromLTRB(context.pageHorizontalPadding, 0,
                context.pageHorizontalPadding, 16),
            child: TextField(
  ...
  Widget build(BuildContext context) {
    return SliverPadding(
      padding: EdgeInsets.fromLTRB(
          context.pageHorizontalPadding, 0, context.pageHorizontalPadding, 24),
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    Padding(
                        ...
                        child: RoomBrowserSkeletonLine(widthFactor: 0.64)),
                    Padding(
                        padding: EdgeInsets.fromLTRB(10, 8, 10, 0),
                        child: RoomBrowserSkeletonLine(widthFactor: 0.48)),
                    Padding(
                        padding: EdgeInsets.fromLTRB(10, 10, 10, 0),
                        child: RoomBrowserSkeletonPill()),
                  ],
                ),
              ),
              childCount: cols * 2,
