...
class TopEightManagementScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TopEightManagementScreen> createState() => _TopEightManagementScreenState();
}

class _TopEightManagementScreenState extends ConsumerState<TopEightManagementScreen> {
                      ...
                      Expanded(
                        child: ReorderableListView.builder(
                          ...
                          onReorder: (oldIndex, newIndex) {
                            ref.read(topEightControllerProvider.notifier).reorderTopEight(oldIndex, newIndex);
                          },
                              ...
                              trailing: Row(
                                ...
                                children: [
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      ref.read(topEightControllerProvider.notifier).removeFromTopEight(user.id);
                                    },
                                  ),
              ...
              children: [
                ...
                Expanded(
                  child: friendsAsync.when(
                    ...
                    error: (err, stack) => Center(child: Text('Error: $err', style: const TextStyle(color: Colors.white))),
                    data: (friends) {
                      final topEightIds = topEightUsersAsync.value?.map((e) => e.id).toList() ?? [];
                      final filteredFriends = friends.where((f) {
                        final matchesSearch = f.username.toLowerCase().contains(_searchQuery);
                      ...
                      if (filteredFriends.isEmpty) {
                        return const Center(
                          child: Text('No friends found', style: TextStyle(color: Colors.grey)),
                        );
                      }
