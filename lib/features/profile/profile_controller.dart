...
class ProfileState {
  ...
  ProfileState copyWith(
      ...
      String? vibePrompt,
      String? firstDatePrompt,
      String? musicTastePrompt,
      String? profileAccentColor,
      String? profileBgGradientStart,
      String? profileBgGradientEnd,
    ...
    return ProfileState(
      ...
      vibePrompt: vibePrompt ?? this.vibePrompt,
      firstDatePrompt: firstDatePrompt ?? this.firstDatePrompt,
      musicTastePrompt: musicTastePrompt ?? this.musicTastePrompt,
      profileAccentColor: profileAccentColor ?? this.profileAccentColor,
      profileBgGradientStart:
          profileBgGradientStart ?? this.profileBgGradientStart,
      profileBgGradientEnd: profileBgGradientEnd ?? this.profileBgGradientEnd,
