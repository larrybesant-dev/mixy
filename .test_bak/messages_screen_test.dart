...
Widget _buildApp({
  ...
  final lifecycleManager = StreamLifecycleManager();
  lifecycleManager.updateRoute('/messages');
  ...
  final router = GoRouter(
    ...
    routes: [
      GoRoute(
        path: '/messages',
        builder: (__, _) => MessagesScreen(userId: userId, username: username)),
      GoRoute(
        path: '/messages/new',
        builder: (__, _) => const Scaffold(body: Text('New message'))),
      GoRoute(
        path: '/messages/:conversationId',
        builder: (__, _) => const Scaffold(body: Text('Chat'))),
    ]);

  return ProviderScope(
    overrides: [
      firestoreProvider.overrideWithValue(firestore),
      streamLifecycleManagerProvider.overrideWith((ref) => lifecycleManager),
    ],
