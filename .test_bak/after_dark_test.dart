  ...
  final router = GoRouter(
    ...
    routes: [
      GoRoute(
        ...
        builder: (__, _) => const AfterDarkAgeGateScreen()),
      GoRoute(
        path: '/after-dark/pin-setup',
        builder: (__, _) => const Scaffold(body: Text('Pin Setup'))),
      GoRoute(
        path: '/settings',
        builder: (__, _) => const Scaffold(body: Text('Settings'))),
    ]);
...
Widget _pinSetupApp() {
  final router = GoRouter(
    ...
    routes: [
      GoRoute(
        path: '/after-dark/pin-setup',
        builder: (__, _) => const AfterDarkPinScreen.setup()),
      GoRoute(
        path: '/after-dark',
        builder: (__, _) => const Scaffold(body: Text('After Dark Home'))),
      GoRoute(
        path: '/settings',
        builder: (__, _) => const Scaffold(body: Text('Settings'))),
    ]);
  ...
  final router = GoRouter(
    ...
    routes: [
      GoRoute(
        ...
        builder: (__, _) => const AfterDarkPinScreen.unlock()),
      GoRoute(
        path: '/after-dark',
        builder: (__, _) => const Scaffold(body: Text('After Dark Home'))),
      GoRoute(
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            ...
            builder: (__, _) => const Scaffold(body: Text('Lounges'))),
          GoRoute(
            path: '/after-dark/profile',
            builder: (__, _) => const Scaffold(body: Text('AD Profile'))),
        ]),
      GoRoute(
        path: '/after-dark/unlock',
        builder: (__, _) => const Scaffold(body: Text('Unlock'))),
      GoRoute(
        path: '/',
        builder: (__, _) => const Scaffold(body: Text('Main App'))),
    ]);
